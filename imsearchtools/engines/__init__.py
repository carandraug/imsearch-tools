...
class SearchClient:
    ...
    def _fetch_results(self, query, num_results, aux_params={}, headers={}):
        ...
        if self.async_query:
            jobs = [
                gevent.spawn(
                    self._fetch_results_from_offset,
                    query,
                    result_offset,
                ...
                for result_offset in range(
                    0, num_results, self._results_per_req
                )
            ]
